...
async def main():
    ...
    # -------------------------------
    # Можно инициировать для всех активных пользователей
    ...
    # Пример запроса
    response = await gpt.safe_ask(user_id="example_user", messages=[{"role":"user","content":"Привет, Ра!"}])
    ...
    while True:
        await asyncio.sleep(60)  # держим живой цикл
