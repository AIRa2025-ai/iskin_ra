...
class ИсконнаяМера:
    ...
    def вычислить_гармонию(self, текущее_время: datetime = None) -> float | str:
        ...
        if (4 <= час <= 6) or фаза_луны == "полная":
            ...
            logging.info(
                f"Гармония рассчитана: {гармония:.2f}, "
                f"фаза луны: {фаза_луны}, "
                f"ритмы_коэф: {ритмы_коэф:.3f}, "
    ...
    def получить_фазу_луны(self, дата: datetime) -> str:
